...
2. Open `cog.py` in the same folder and import "CardGenerator". If you need a reminder on how to import or don't know how, click [here](https://github.com/ContestedWheel/EvalEvalEval-BD/wiki/Adding-custom-commands#importing)
