# Improved rarity command made by Nixter.
# This is the rarity command from CarFigures converted to Ballsdex by me.
# If you are looking for the original one made for Ballsdex, open "classic_rarity.py" instead.
